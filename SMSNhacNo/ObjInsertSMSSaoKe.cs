...
namespace SMSNhacNo
{
    class ObjInsertSMSSaoKe
    {
        ...
        private string statementAmt;

        public ObjInsertSMSSaoKe() {}

        public ObjInsertSMSSaoKe(string id, string smsType, string smsDetail, string desMobile,
            ...
            string loc, string idStatement, string statementAmt)
        {
            this.id = id;
        ...
        public string getStatementAmt()
        {
            return this.statementAmt;
        }

        public void setStatementAmt(string statementAmt)
        {
            this.statementAmt = statementAmt;
        }
